...
<c:if test="${empty requestScope.ur}" >
   <script>location.href="UserResServlet.do?op=showsel";</script>
   return;
</c:if>

<div id="previewWrapper">
        <div class="preview_header">
            <h1 title="jason的简历">${ur.urname }的简历</h1>
                        	<a title="下载简历" class="inline cboxElement" href="#downloadOnlineResume"></a>
        ...
        <div class="preview_content">
            <div class="profile_box" id="basicInfo">
                ...
                <div class="basicShow">
                   <span>${ur.urname }| 
                    ${ur.ursex} |                     ${ur.ureducation} |                                       		${ur.urexperience}工作经验
            		            			|${ur.arid}<br>
            			            				${ur.biid} | ${ur.ureducation} · ${ur.urschool }<br>
	                ...
	                <div class="expectShow">
	                	${ur.arid}，${ur.urnature}，${ur.biid }，${ur.urmoney }
	                </div><!--end .expectShow-->
	            </div><!--end #expectJob-->
	                ...
	                <div class="experienceShow">
	                  <ul class="wlist clearfix">
	                  	         <li class="clear">
            					      <span class="c9"></span>
	           					<div>
	           						<img width="56" height="56" alt="" src="${resume.urpicture }">
	           						<h3>${ur.biid}</h3>
	           					</div>
	           					
	           				</li>
	           				<c:forEach var="w" items="${worklist}">
	           				    <p><h4>${w.company},${w.jobname},${w.starttime},${w.overtime }</h4></p>
	           				</c:forEach>
	           				</ul>
	                  ...
	                  <ul class="plist clearfix">
		            					...
		            					<div class="f16 mb10">
		            					 <c:forEach var="p" items="${plist}">  
		            					         <p>${p.projectname },${p.theposter },${p.projectstarttime },
		            					${p.projectendtime },${p.projectdescription }</p>
		            					</c:forEach>
		            						<span class="c9">
	                ...
	                <div class="educationalShow">
	                  <ul class="elist clearfix">
            					...
            					<div>
            						<h3>${ur.urschool}</h3>
            						<h4>${ur.ursubject}，${ur.ureducation}，${ur.uryear}</h4>
            					</div>
            				</li>
            				           					                  </ul>
	                ...
	                <div class="workShow">
	                  <ul class="slist clearfix">
            				            					...
            				            					<div class="workList c7">
	            						            							            							<div class="f16">网址：<a target="_blank" href="${ur.uraddress}">${ur.uraddress}</a></div>
	            							            						            					<p>产品 </p>
	            				</div>
            				</li>
            				           					                  </ul>
