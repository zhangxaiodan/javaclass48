...
<title>公司介绍-招聘服务-握手网-最专业的互联网招聘平台</title>
	...
	<div id="header">
    	<div class="wrapper">
    		...
    		<ul id="navheader" class="reset">
    			<li><a href="index05.jsp">首页</a></li>
    			<li class="current"><a href="index05.jsp">公司</a></li>
    			<!-- <li><a target="_blank" href="">论坛</a></li> -->
    				    			<li>
	    				<a rel="nofollow" href="index05.jsp">简历管理</a>
	    					    			</li>
	    							    			<li><a rel="nofollow" href="index05.jsp">发布职位</a></li>
	    		    		</ul>
        ...
        <div class="content_mid">
            <dl class="c_section c_section_mid">
                ...
                <dd>
                    ...
                    <form action="<%=request.getContextPath()%>/BusinessInfoServlet.do?op=add05" method="post" >
