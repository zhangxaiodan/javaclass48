...
<title>公司产品-招聘服务-握手网-最专业的互联网招聘平台</title>
	...
	<div id="header">
    	<div class="wrapper">
    		...
    		<ul id="navheader" class="reset">
    			<li><a href="index04.jsp">首页</a></li>
    			<li class="current"><a href="index04.jsp">公司</a></li>
    			<!-- <li><a target="_blank" href="">论坛</a></li> -->
    				    			<li>
	    				<a rel="nofollow" href="index04.jsp">简历管理</a>
	    					    			</li>
	    							    			<li><a rel="nofollow" href="index04.jsp">发布职位</a></li>
	    		    		</ul>
            ...
            <dl class="c_section c_section_mid">
                ...
                <dd>
                	<div class="c_text">目标明确、前途光明的产品是吸引求职者的制胜法宝哦！</div>
                     ...
                     <form action="<%=request.getContextPath()%>/BusinessInfoServlet.do?op=add04" method="post" enctype="multipart/form-data">
                    	...
                    	<div id="productDiv">
		                    <div class="formWrapper">
		                        ...
		                        <div class="c_logo c_logo_pos">
			                    	<input type="file" title="上传公司产品海报" id="filename" name="filename"/>
				                        <div id="logoNo">
				                    		<span>上传公司产品海报</span> <br>
									                            尺寸：380*220px  <br>
									                            大小：小于5M
										</div>
                    	...
                    	<a class="btn_cancel fr" href="http://index05.jsp">跳过</a>
                    </form>
                </dd>
            </dl>
       	</div>
