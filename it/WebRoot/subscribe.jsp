...
<title>职位订阅-握手网-最专业的互联网招聘平台</title>
<meta property="qc:admins" content="23635710066417756375" />
<meta content="握手网是3W旗下的互联网领域垂直招聘网站,互联网职业机会尽在握手网" name="description">
<meta content="握手,握手网,握手招聘,拉钩, 拉钩网 ,互联网招聘,握手互联网招聘, 移动互联网招聘, 垂直互联网招聘, 微信招聘, 微博招聘, 握手官网, 握手百科,跳槽, 高薪职位, 互联网圈子, IT招聘, 职场招聘, 猎头招聘,O2O招聘, LBS招聘, 社交招聘, 校园招聘, 校招,社会招聘,社招" name="keywords">
...
$(document).ready(function() {
     /*接收邮箱验证*/
		$("#subEmail").mouseover(function () {
			var email = $("#subEmail").val();
			var reg = /^\w+@\w+(\.[a-zA-Z]{2,3}){1,2}$/;
		  if(email==""){
		      $("#email_prompt").html("请输入邮箱号码");
		      return false;
	...
	//职位名称
	$("#select_city_hidden").mouseover(function (){
	       var job= $("#select_city_hidden").val();
	       if(job==""){
	           $("#city_prompt").html("请输入职位名称");
	       }else{
	           $("#city_prompt").html("");
	       }
	});
	...
	<div id="header">
    	<div class="wrapper">
    		<a href="index.html" class="logo">
    			<img src="style/images/logo.png" width="229" height="43" alt="握手招聘-专注互联网招聘" />
    		</a>
                ...
                <form id="subForm"  >
	                ...
	                <div class="s_form">
	                    ...
	                    <dl>
	                        ...
	                        <dd>
	                        	<input type="text" id="subEmail" name="email" placeholder="请输入接收邮箱" value="" required="required"/>	
	                        	<div id="email_prompt" style="color:#ff0000;"></div>
	                    ...
	                    <dl>
	                        ...
	                        <dd>
	                        	<input type="hidden" id="select_job_hidden" name="positionName" value="" />
	                       		<input type="button" class="select" id="select_job" value="请选择职位名称"  required="required" />
	                       		<div id="job_prompt"></div>
	                    ...
	                    <dl>
	                        ...
	                        <dd>
	                        	<input type="hidden" id="select_city_hidden" name="city" value=""  required="required"/>
	                        	<div id="city_prompt"></div>
	                            <ul class="s_radio clearfix">
	                            		     <li title="北京">北京</li>
	                            			                            		                            			                            		<li title="上海">上海</li>
	                            			                            		                            			                            		<li title="广州">广州</li>
	                    ...
	                    <input type="button" class="btn_big" id="subSubmit" value="保 存" onclick="subFormSave()" />
...
<div style="display:none;">	
	...
	-->
		<div id="subscribeSuccessRegister" class="popup" style="height:370px;">
        	...
        	<hr>
        	<p>现在只需设置密码就可成功注册握手，并可长期保存及管理订阅信息。</p>
	                ...
	                <tr>
	                	...
	                	<td>
	                		<label class="fl" for="checkbox">
	                			...
	                			我已阅读并同意<a href="h/privacy.html" target="_blank">《握手用户协议》</a>
	                		</label>
	                	</td>
	                </tr>
	            	<tr>
    ...
    <div id="cancelSub" class="popup">
       	...
       	<table width="100%">
       		<tr>
       			<td align="center"><p>点击确认后你将不再收到握手为你提供的精准职位推送。</p></td>
       		</tr>
        	<tr>
            	<td align="center">
