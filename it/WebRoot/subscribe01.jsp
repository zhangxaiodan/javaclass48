...
<script src="style/js/ajaxCross.json" charset="UTF-8"></script>
 ...
 <script type="text/javascript">
  $(function(){
  $("input").css("color","#ffffff").css("background-color","#93B7BB");
  } );
  </script>
...
<c:if test="${empty requestScope.dylist}" >
   <script>location.href="UserResServlet.do?op=seldy";</script>
   return;
</c:if>
...
<div id="body">
    ...
    <div id="container">
        ...
        <div class="clearfix">
            ...
            <form id="subscribeForm" >
            	<h1>我的职位订阅</h1>
            	  <c:forEach var="d" items="${dylist.list}">
            	            		                <div class="selected s1">
            	            		               
	                	<h2>${d.liJob}</h2>
	                	<div class="sbox" >
	                    	 <input type="hidden" name="liid" value="${d.liId}" id="liid"/>
           
	                      <p align="middle"><input type="button" value="取消职位订阅" onclick="subscribeFormSave()"></p>
	                    </div>
 ...
 <div align="center"> 
  <c:if test="${dylist.pageIndex>1 }">
     <a href="UserResServlet.do?op=seldy&index=1">首页</a>
     <a href="UserResServlet.do?op=seldy&index=${dylist.pageIndex-1}">上一页</a>
  </c:if>
  <c:if test="${dylist.pageIndex<dylist.totalPage }">
     <a href="UserResServlet.do?op=seldy&index=${dylist.pageIndex+1 } ">下一页</a>
     <a href="UserResServlet.do?op=seldy&index=${dylist.totalPage}">末页</a>
  </c:if>
  第${dylist.pageIndex }页/共${dylist.totalPage }页
 </div>
  </form>
...
<!--  <script>
  ...
  <input id="d1" type="text" class="Wdate" readonly="readonly" 
  	onClick="WdatePicker({el:this,dateFmt:'yyyy-MM-dd'})" />
  	<br />-->
  	<!--  <input id="btn" type="button" value="获取日期" onclick="showDate()" />-->
	                ...
	                <tr>
	                	...
	                	<td>
	                		<label for="checkbox" class="fl">
	                			...
	                			我已阅读并同意<a target="_blank" href="http://www.lagou.com/privacy.html">《握手用户协议》</a>
	                		</label>
	                	</td>
	                </tr>
	            	<tr>
