...
<html xmlns:wb="http://www.w3.org/1999/xhtml">
<head>
...
<div id="body">
    ...
    <div id="container">
		...
		<div id="sidebar">
			...
			<div class="mainNavs">
						...
						<div class="menu_main">
							...
							<h2>技术 <span></span></h2>
											            					            		<a href="joblist.jsp">Java</a>
				<a href="joblist.jsp">PHP</a>
				<a href="joblist.jsp">C</a>
				<a href="joblist.jsp">C++</a>
				<a href="joblist.jsp">Android</a>
				<a href="joblist.jsp">iOS</a>
				<a href="joblist.jsp">前端开发</a>
				<a href=‘joblist.jsp">测试</a>
				<a href="joblist.jsp">技术经理</a>
				<a href="joblist.jsp">项目经理</a>
				<a href="joblist.jsp">架构师</a>
			</div>
					   	<div class="menu_sub dn">
					   								    	<dl class="reset">
					        							        		<dt>
					        			<a href="zhiweidashouye.jsp">
					        									            								            							            								            							            								            							            								            							            								            							            								            						        				后端开发
					        			</a>
					        		</dt>
						        	<dd>
        ...
        <div class="content">	
	        			<div id="search_box">
		<form id="search" name="search" action="JobsServlet.do" method="get">
        <ul id="searchType">
        	        	<li data-searchtype="1" class="type_selected">职位</li>
        	<li data-searchtype="4">公司</li>
        	        </ul>
        <div class="searchtype_arrow"></div>
        <input type="text" id="search_input" name = "kd"  tabindex="1" value=""  placeholder="请输入职位名称，如：产品经理" style="width:300px; height:35px;font-size:20px" />
...
<dl class="hotSearch">
	<dt>热门搜索：</dt>
	<dd><a href="joblist.jsp">Java</a></dd>
	<dd><a href="joblist.jsp">PHP</a></dd>
	<dd><a href="joblist.jsp">Android</a></dd>
	<dd><a href="joblist.jsp">iOS</a></dd>
	<dd><a href="joblist.jsp">前端</a></dd>
	<dd><a href="joblist.jsp">产品经理</a></dd>
	<dd><a href="joblist.jsp">UI</a></dd>
	<dd><a href="joblist.jsp">运营</a></dd>
	<dd><a href="joblist.jsp">BD</a></dd>
	<dd><a href="joblist.jsp">实习</a></dd>
</dl>			
			<div id="home_banner">
	            <ul class="banner_bg">
	            		                <li  class="banner_bg_1 current" >
	                    <a href="h/subject/s_buyfundation.html?utm_source=DH__lagou&utm_medium=banner&utm_campaign=haomai" target="_blank"><img src="style/images/d05a2cc6e6c94bdd80e074eb05e37ebd.jpg" width="612" height="160"  /></a>
	                </li>
	                    ...
	                    <a href="http://www.youku.com/" target="_blank">
	                        ...
	                        <div class="hot_info">
	                            ...
	                            <p title="专注于视频领域，是中国网络视频行业领军企业">
                	        		...
                	        		<li >
	                    <a href="https://www.thoughtworks.com/cn/" target="_blank">
            ...
            <div id="hotList">
	            ...
	            <c:forEach var="j" items="${jobList}">
	            		            		            				            		<li class="clearfix">
		            																		            					                	<div class="hot_pos_l">
			                    	<div class="mb10">
			                        	<a href="joblist.jsp" target="_blank">${j.recruit.brJob}</a> 
			                            &nbsp;
			                	...
			                	<div class="hot_pos_r">
			                    	<div class="mb10 recompany"><a href="h/c/399.html" target="_blank">${j.bujName}</a></div>
			                        ...
			                        <ul class="companyTags reset">
	                		                	            				            		...
	                		                	            				            		<li class="odd clearfix">
		            																		            					                	<div class="hot_pos_l">
			                    	<div class="mb10">
			                        	<a href="joblist.jsp" target="_blank">售前工程师（运维经验优先）</a> 
			                            &nbsp;
			                	...
			                	<div class="hot_pos_r">
			                        ...
			                        <ul class="companyTags reset">
	                		                	            				            		...
	                		                	            				            		<li class="clearfix">
		            																		            					                	<div class="hot_pos_l">
			                    	<div class="mb10">
			                        	<a href="joblist.jsp" target="_blank">手机游戏运营</a> 
			                            &nbsp;
			                	...
			                	<div class="hot_pos_r">
			                    	<div class="mb10 recompany"><a href="joblist.jsp" target="_blank">百度移动游戏</a></div>
			                        ...
			                        <ul class="companyTags reset">
	                		                	            				            		...
	                		                	            				            		<li class="odd clearfix">
		            																		            					                	<div class="hot_pos_l">
			                    	<div class="mb10">
			                        	<a href="joblist.jsp" target="_blank">iOS</a> 
			                            &nbsp;
			                            <span class="c9">[北京]</span>
			                            			                        </div>
			                	...
			                	<div class="hot_pos_r">
			                        ...
			                        <ul class="companyTags reset">
	                	                ...
	                	                <a href="zhiweidashouye.jsp" class="btn fr" >查看更多</a>
	                	            </ul>
	            <ul class="hot_pos hot_posHotPosition reset" style="display:none;">
			                	...
			                	<div class="hot_pos_r">
			                        ...
			                        <ul class="companyTags reset">
	                	                	                ...
	                	                	                <a href="joblist.jsp" class="btn fr" target="_blank">查看更多</a>
	            </ul>
            </div>
