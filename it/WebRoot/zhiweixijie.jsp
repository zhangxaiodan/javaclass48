...
<title>内容运营-立方网-握手网-最专业的互联网招聘平台</title>
<meta property="qc:admins" content="23635710066417756375" />
<meta content="内容运营 武汉 本科 3-5年 全职 运营 大家都来了 你还在等什么！！ 立方网 北京立方网信息技术有限公司 立方网努力尝试把许多人对互联网的需求从现有的娱乐、资讯和交流平台进一步引导到文化与生活伴侣的方面. 握手网-最专业的互联网招聘平台" name="description">
<meta content="内容运营 武汉 本科 3-5年 全职 运营 大家都来了 你还在等什么！！ 立方网 北京立方网信息技术有限公司 立方网努力尝试把许多人对互联网的需求从现有的娱乐、资讯和交流平台进一步引导到文化与生活伴侣的方面. 握手网-最专业的互联网招聘平台" name="keywords">
    	...
    	<div class="wrapper">
    		...
    		<ul id="navheader" class="reset">
    			...
    			<li><a  href="<%=request.getContextPath()%>/BusinessInfoServlet.do?op=gongsijianli&name=<%=bi.getBuName()%>">简历管理</a></li>
    				    			<li><a rel="<%=request.getContextPath()%>/BusinessInfoServlet.do?op=zhiwei01&name=<%=bi.getBuName()%>">发布职位</a></li>
	    						    		</ul>
    ...
    <div id="container">
            ...
            <div class="content_l">
                    ...
                    <dd class="job_request">
                    	<span class="red">${bi.recruit.brMoney}</span>
                       	<span>${bi.recruit.brCity}</span> 
                       	<span>经验${bi.recruit.brExperience} </span>
                       	<span> ${bi.recruit.brEducation}及以上</span> 
                       	<span>${bi.recruit.brNature}</span><br />
                      	  职位诱惑 : ${bi.recruit.brLikeJob}
                      	<div>发布时间：${bi.recruit.brTime}</div>
                    </dd>
                    <dd class="job_bt">
            ...
            <div class="content_r">
                <dl class="job_company">
                    <dt>
                    	<a href="${bi.buHomePage}" target="_blank">
                            <img class="b2" src="${bi.buLogo}" width="80" height="80" alt="${bi.buLogo}" />
                            <div>
                                <h2 class="fl">
                                	                                  		${bi.buName}
                                  	                                  	
                                  	                                    	
                                    	<span class="dn">握手认证企业</span>
                    ...
                    <dd>
                    	<ul class="c_feature reset">
                        	<li><span>领域</span> ${bi.buBigJob}</li>
                        	<li><span>规模</span> ${bi.buSize}</li>
                        	<li>
                        		<span>主页</span> 
                        		           							<a href="${bi.buHomePage}" target="_blank" title="${bi.buHomePage}" rel="nofollow">${bi.buHomePage}</a>
           						                        	</li>
                        </ul>
                        
                        <h4>发展阶段</h4>
                        <ul class="c_feature reset">
                        	<li><span>目前阶段</span>${bi.buDevelopment}</li>
	    	...
	    	<tr>
	        	<td>
                    <form  id="resumeSetForm" class="resumeSetForm">
            			...
            			<div class="setBtns">
            											<a href="gongsijianli.html" target="_blank">修改</a>
            			</div>
	            		<div class="clear"></div>
	            		<label class="radio">
        ...
        <table width="100%">
            <tr class="drawGGJ">
                <td align="center">
                	...
                	<p class="font_16 share dn">邀请好友成功注册握手，可提升每日投递量 &nbsp;&nbsp; <a href="h/share/invite.html" target="_blank">邀请好友>></a></p>
                </td>
            </tr>
        	<tr class="drawQD">
            	<td align="center"><a href="javascript:top.location.reload();" class="btn_s">确&nbsp;定</a></td>
	    	...
	    	<tr>
	        	<td align="center">
                   <form>
                    ...
                    <a class="btn" href="gongsijianli.html" target="_blank">完善在线简历</a>
	            </td>
	        </tr>
	    </table>
	</div><!--/#sendNoResume-->
...
<script type="text/javascript">
		...
		if($('#positionLat').val() && $('#positionLng').val()){
			...
			sMyGeo.getPoint("${bi.recruit.brAddress}", function(sPoint){
			  if (sPoint) {
		...
		$(function(){
			$('#mapPreview').bind('click',function(){
				...
				var address = "${bi.recruit.brAddress}";
				var city = "${bi.recruit.brCity}";
