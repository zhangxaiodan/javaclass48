<%@ page language="java" contentType="text/html; charset=UTF-8"
 ...
 <script type="text/javascript" src="${pageContext.request.contextPath}/js/jianli.js">
</script>
<!DOCTYPE HTML>
...
<title>产品经理-百田-握手网-最专业的互联网招聘平台</title>
<meta content="23635710066417756375" property="qc:admins">
<meta name="description" content="产品经理 广州 本科 1-3年 全职 产品经理 上市公司，快速发展空间，产品的话语权 广州百田 广州百田信息科技有限公司 专注于儿童互联网市场的发展和创新，为中国少年儿童提供互联网互动娱乐和学习服务。 握手网-最专业的互联网招聘平台">
<meta name="keywords" content="产品经理 广州 本科 1-3年 全职 产品经理 上市公司，快速发展空间，产品的话语权 广州百田 广州百田信息科技有限公司 专注于儿童互联网市场的发展和创新，为中国少年儿童提供互联网互动娱乐和学习服务。 握手网-最专业的互联网招聘平台">
...
<c:if test="${empty requestScope.u}" >
   <script>location.href="UserResServlet.do?op=addrem";</script>
   return;
</c:if>
<div id="body">
	<div id="header">
    ...
    <div id="container">
            ...
            <div class="content_l">
                    ...
                    <dt>
                        ...
                        <form id="jd_collection" action="UserResServlet.do?op=show" method="post">                      	
                         	    
                  	           <input type="hidden" name="id" value="1"/>
                       	           
                       	         <input type="submit" style="color:#91CEBE;background-color:#FAFAFA;font-size:20px;padding-left:420px;"  value="收藏" onclick="jd_collectionSave()"/>
...
<p>3、每周定期举办足球、羽毛球、篮球及员工深度互动等文体活动。</p>
				                        ...
				                        <div>
								          <span> 你已有可投递的在线简历：<a title="jason的简历" target="_blank" href="jianli.html"><strong></strong></a></span><br>
								          <span>简历更新于2019-01-11 15:53</span>
				                        </div>
				                        <span class="setBtns">
				                        	<a target="_blank" title="预览" href="preview.jsp">预览</a> |
	        	...
	        	<td>
                    <form class="resumeSetForm" id="resumeSetForm">
	            		<label class="radio">
	            			...
	            			在线简历：
	            				<span title="jason的简历">张莹莹的简历</span>
	            		</label>
            			<div class="setBtns">
	            	   ...
	            	   <span class="uploadedResume red">暂无附件简历</span>
	            		...
	            		<input type="button" value="保存设置" class="btn_profile_save btn_s" onclick="addremSave()">
	            	</form>
	            </td>
	        </tr>
	    </tbody></table>
...
<!-- 投递简历时  - 设置默认投递简历 -->
	<div style="height:280px;" class="popup" id="setResumeApply">
	    <table width="100%">
	    	...
	    	<tr>
	        	<td>
                    <form action="UserResServlet.do?op=Ajaxaddremm" class="resumeSetForm"   id="addremm"   method="post">
	            		<label class="radio">
	            			<input type="radio" value="1" class="resume1" name="resumeName" 
	            			  <c:if test="${uis_default.is_default==1 }">checked </c:if>/>
	            			在线简历：
	            				            				<span title="简历">简历投递</span>
	            				            		</label>
            			<div class="setBtns">
            					        <a target="_blank" href="preview.jsp">预览</a> |
	            						<a target="_blank" href="jianli.jsp">修改</a>
	            		...
	            		<label class="radio">
	            			<input type="radio" value="0" class="resume0" name="resumeName"
	            			<c:if test="${uis_default.is_default==0 }">checked </c:if>/>
	            			附件简历：
	            				            				<span class="uploadedResume red">附件简历投递</span>
	            				            		</label>
	            		<div class="setBtns">
	            				            				<a class="downloadResume dn" href="h/nearBy/downloadResume">下载</a> <span class="dn">|</span>
            			...
            			<div class="clear"></div>
            			<span style="display:none;" class="error">只支持word、pdf、ppt、txt、wps格式文件，请重新上传</span>
	            		<label class="bgPink"><input type="checkbox" checked="checked">默认使用此简历直接投递</label>
	            		<span class="setTip error"></span>
	            		<input type="hidden" name="urid" value="${u.urid }"/>
	            		<input type="hidden" name="name" value="${u.urname }"/>
	            		<input type="hidden" name="sex" value="${u.ursex}"/>
	            		<input type="hidden" name="education" value="${u.ureducation }"/>
	            		<input type="hidden" name="experience" value="${u.urexperience }"/>
	            		<input type="hidden" name="city" value="${u.arid}"/>
	            		<input type="hidden" name="job" value="${u.biid}"/>
	            		<input type="hidden" name="phone" value="${u. urphone}"/>
	            		<input type="hidden" name="email" value="${u. uremail }"/>
	            		<input type="hidden" name="nature" value="${u. urnature}"/>
	            		<input type="hidden" name="money" value="${u.urmoney }"/>
	            		<input type="hidden" name="project" value="${u.urproject}"/>
	            		<input type="hidden" name="address" value="${u.uraddress }"/>
	            		<input type="hidden" name="year" value="${u. uryear}"/>
	            		<input type="hidden" name="school" value="${u. urschool}"/>
	            		<input type="hidden" name="subject" value="${u.ursubject }"/>
	            		<input type="hidden" name="introduce" value="${u.urintroduce}"/>
	            		<input type="hidden" name="describe" value="${u.urdescribe}"/> 
	            		<input type="hidden" name="time" value="${u.urtime }"/> 
	            		<input type="hidden" name="picture" value="${u.urpicture}"/> 
	            			
	            		<input type="submit" value="提交" class="btn_profile_save btn_s" >
	            	</form>
	            </td>
	        </tr>
	    </tbody></table>
	...
	<div class="popup" id="uploadFileSuccess">
         ...
         <table width="100%">
         	...
         	<tr>
             	<td align="center"><a class="btn_s" href="">确&nbsp;定</a></td>
             </tr>
         </tbody></table>
        ...
        <table width="100%">
            <tbody><tr class="drawGGJ">
                <td align="center">
                	...
                	<p class="font_16 share dn">邀请好友成功注册握手，可提升每日投递量 &nbsp;&nbsp; <a target="_blank" href="h/share/invite.html">邀请好友&gt;&gt;</a></p>
                </td>
            </tr>
        	<tr class="drawQD">
            	<td align="center"><a class="btn_s" href="">确&nbsp;定</a></td>
