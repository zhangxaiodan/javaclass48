...
<title>发布新职位-招聘服务-握手网-最专业的互联网招聘平台</title>
...
<script src="style/js/conv.js" type="text/javascript"></script>
   ...
   <script type="text/javascript">
       $(document).ready(function(){
              var Uarry=$("#haha1 li");//获取所有的li元素
              $("#haha1 li").click(function(){//点击事件
        ...
        $(document).ready(function(){
              var Uarry=$("#haha2 li");//获取所有的li元素
              $("#haha2 li").click(function(){//点击事件
                   var count=$(this).index();//获取li的下标
                   var Tresult=Uarry.eq(count).text();
                   $("#edu").val(Tresult);
                  /*  var v=$(this).text(); alert(v);  */
      ...
      $(document).ready(function(){
              $("#formSubmit").click(function(){//点击事件
    		...
    		<ul id="navheader" class="reset">
    			...
    			<!-- <li><a target="_blank" href="">论坛</a></li> -->
	    				...
	    				<a rel="nofollow" href="<%=request.getContextPath()%>/BusinessInfoServlet.do?op=gongsijianli&name=<%=bi.getBuName()%>">简历管理</a>
	    							    			...
	    							    			<li class="current"><a rel="nofollow" href="<%=request.getContextPath()%>/BusinessInfoServlet.do?op=zhiwei01&name=<%=bi.getBuName()%>">发布职位</a></li>
	    		    		</ul>
            	...
            	<dt>
            		...
            		<i></i>
                                	...
                                	<dd style="display: none;"><a href="<%=request.getContextPath()%>/BusinessInfoServlet.do?op=zhiweisy&name=<%=bi.getBuName()%>">我发布的职位</a></dd>
   ...
   <div class="f24">307220692</div>
            ...
            <div class="content">
            	<dl class="company_center_content">
                    ...
                    <dd>
                    	<form action="<%=request.getContextPath()%>/BusinessInfoServlet.do?op=zhiwei02&id=<%=bi.getBuId()%>&name=<%=bi.getBuName()%>" method="post" id="jobForm">
                            ...
                            <table class="btm">
                            	<tr>
                                	...
                                	<td>职位名称</td>
                                	<td>
                                    	<input type="text" placeholder="请输入职位名称，如：产品经理" value="" name="positionName" id="positionName" onblur="check();"/>
                            ...
                            <table class="btm">
								...
								<tr>
                                	...
                                	<td>
                                    	<div class="salary_range">
                                            <div>
                                                <input type="text" placeholder="最低月薪" value="" id="Min" name="salaryMi" onblur="check1();"/> 
                                                <span>—</span>
                                            </div>
                                            <div>
                                                <input type="text" placeholder="最高月薪" value="" id="Max" name="salaryMa" onblur="check2();"/> 
                                                <span>k</span>
                                            </div>
                            	...
                            	<tr>
                                	...
                                	<td>工作城市</td>
                                	<td>
                                    	<input type="text" placeholder="请输入工作城市，如：北京" value="" name="workAddres" id="workAddress">
                                    </td>
                                </tr>
                            </tbody></table>
                            ...
                            <table class="btm">
                            	<tbody><tr>
                                	...
                                	<td width="85">工作经验</td>
                                	<td>
                                    	<input type="hidden" id="exper" value="" name="workYea">
                            	...
                            	<tr>
                                    ...
                                    <!--<h3><span>(最高月薪不能大于最低月薪的2倍)</span></h3> -->
                                	<td>
                                    	<input type="hidden" id="edu" value="" name="educatio">
                            ...
                            <table class="tm">
                            	<tbody><tr>
                                	...
                                	<td width="85">职位诱惑</td>
                                	<td>
                                    	<input type="text" placeholder="20字描述该职位的吸引力，如：福利待遇、发展前景等" value="" name="positionAdvantag" class="input_520" id="positionAdvantag">
                                    </td>
                                </tr>
                            	<tr>
                                	<td><span class="redstar"></span></td>
                                	...
                                	<td>
                                        ...
                                        <textarea name="positionDetai" placeholder="建议分条描述工作职责等" id="positionDetai"  ></textarea>
                                ...
                                <tr>
                                	...
                                	<td>工作地址</td>
                                	<td>
                                    	<input type="text" placeholder="请输入详细的工作地址" value="" name="positionAddres" class="input_520" id="positionAddres">	
                            ...
                            <table>
                                ...
                                <tr>
                                	...
                                	<td >
                                    	接受简历邮箱&nbsp;
                                        <input type="text" value="" placeholder="请输入邮箱" id="forwardE" name="forwardEmai">
...
function showInfo(e){
	...
	gc.getLocation(pt, function(rs){
	    var addComp = rs.addressComponents;
	    var label = new BMap.Label("我的坐标："+e.point.lng + ", " + e.point.lat+"  我的地址："+addComp.province + ", " + addComp.city + ", " + addComp.district + ", " + addComp.street + ", " 
	    + addComp.streetNumber,{offset:new BMap.Size(20,-10)});
...
<div id="cboxOverlay" style="display: none;"></div><div id="colorbox" class="" role="dialog" tabindex="-1" style="display: none;"><div id="cboxWrapper"><div><div id="cboxTopLeft" style="float: left;">
</div><div id="cboxTopCenter" style="float: left;"></div><div id="cboxTopRight" style="float: left;"></div></div><div style="clear: left;"><div id="cboxMiddleLeft" style="float: left;"></div><div id="cboxContent" style="float: left;"><div id="cboxTitle" style="float: left;"></div><div id="cboxCurrent" style="float: left;"></div><button type="button" id="cboxPrevious">
</button><button type="button" id="cboxNext"></button><button id="cboxSlideshow"></button><div id="cboxLoadingOverlay" style="float: left;"></div><div id="cboxLoadingGraphic" style="float: left;"></div></div><div id="cboxMiddleRight" style="float: left;"></div></div><div style="clear: left;"><div id="cboxBottomLeft" style="float: left;"></div><div id="cboxBottomCenter" style="float: left;"></div><div id="cboxBottomRight" style="float: left;"></div></div></div>
